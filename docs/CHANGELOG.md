...
- **Theme Consistency**: Unified header and brand styling across Main and Extensions pages by centralizing CSS. Fixed Theme Toggle and icon colors on Extensions page.
